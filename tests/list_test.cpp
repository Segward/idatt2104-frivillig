...
static_assert(!std::is_copy_constructible_v<ListRGA>, "ListRGA must not be copyable");
static_assert(!std::is_copy_assignable_v<ListRGA>, "ListRGA must not be copy-assignable");
static_assert(!std::is_move_constructible_v<ListRGA>, "ListRGA must not be movable");
static_assert(!std::is_move_assignable_v<ListRGA>, "ListRGA must not be move-assignable");
